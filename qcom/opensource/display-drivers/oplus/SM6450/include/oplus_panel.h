...
struct oplus_backlight_config {
	...
	u32 demura2_offset;
	bool bl_demura_compatible_dbv_threshold_support;
	bool bl_demura_send_async_support;
	struct workqueue_struct *oplus_panel_backlight_demura_send_async_wq;
	struct work_struct oplus_panel_backlight_demura_send_async_work;
};
